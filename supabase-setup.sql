-- 🚀 PlayHard Script Hall Database Setup
...
-- Insert scripts data (20 scripts)
...
-- Reset sequence for scripts table
...
-- Show sample data
SELECT id, title, category, monthly_recommended FROM scripts LIMIT 5;
SELECT id, time, description, available FROM time_slots LIMIT 3;

-- 🎉 Setup complete! You can now set NEXT_PUBLIC_USE_SUPABASE=true in your .env.local